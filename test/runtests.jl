...
using PCPOP: OnLetters, PG, Polynomial, add_comms!, coefficient, divide,
    free_part, make_trace_monoid, monomial, monomial_to_foata, state,
    state_part, state_projection, tpop, trace_monomials, word_to_state
