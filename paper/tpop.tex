...
Consider the problem, studied in \cite{Tavakoli2022informationally}, of characterizing correlations in a prepare-and-measure scenario where the information capacity of the ensemble of prepared quantum states is constrined.
The trace polynomial optimization problem reads as follows.
With PCPOP, We reproduce the figure 3 in \cite{Tavakoli2022informationally}.
% \begin{equation}
% \begin{split}
...
\begin{code}
    ...
    ge_constr = [[-σ,-G]]
    # To impsoe the constraint that the states are mixed states.
    ...
    # Notice here we use cyclic=true to do tracial reductions.
\end{code}
\AM{Extend with more examples that solves general state polynomial optimization problems.}