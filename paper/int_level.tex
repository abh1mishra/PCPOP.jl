...
\texttt{PCPOP} provides excellent and simple interface to define intermediate levels of hierarchy. This is useful when some level is not enough and the next integer level is too large to solve. We illustrate all the available ways to define intermediate levels.
