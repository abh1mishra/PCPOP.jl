...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
		\includegraphics[width=\textwidth]{./../Benchmark/plots/benchmark1/startup/M.png}
        \caption{Time PCPOP takes to build the partially comm. monoid}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
		\includegraphics[width=\textwidth]{./../Benchmark/plots/benchmark1/startup/g_vars1vs2.png}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
		\includegraphics[width=\textwidth]{./../Benchmark/plots/benchmark1/normal_form/OSCARvsPCPOP_vars=2.png}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
		\includegraphics[width=\textwidth]{./../Benchmark/plots/benchmark2/normal_form/OSCARvsPCPOP_vars=2.png}
		\caption{Example 11: Comparision of PCPOP vs OSCAR.}
    \end{subfigure}%
    ~ 
    \begin{subfigure}[t]{0.5\textwidth}
        \centering
		\includegraphics[width=\textwidth]{./../Benchmark/plots/benchmark2/normal_form/QuantumNPAvsPCPOP_vars=2.png}
